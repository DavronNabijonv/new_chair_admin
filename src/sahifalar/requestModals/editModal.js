...
export default function EditModal({ close_mod_func , infos }) {
    ...
    const [furnitureInfoEdit, setFurnitureInfoEdit] = useState({
      ...
      const handleChangeEdit = (e) =>{
        setFurnitureInfoEdit({...furnitureInfoEdit,[e.target.name]:e.target.value})
      }
      ...
      const handleSubmitEdit = async (e) => {
        ...
        const res = await patch_furniture(furnitureInfoEdit.id, furnitureInfoEdit, token);
        ...
        <div className="input_grp">
          ...
          <div className="input_grp">
            ...
            <input
               ...
               type="file"
               onChange={(e) => {
                 setFurnitureInfoEdit({ ...furnitureInfoEdit, photo: e.target.files[0] });
               }}
               required
            />
          </div>
